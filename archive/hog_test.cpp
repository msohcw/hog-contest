...
void test_strategy(){
    printf("type: 4    winrate: %f\n", average_win_rate(final_strategy, always_roll_4, 1000000));
    printf("type: rand winrate: %f\n", average_win_rate(final_strategy, always_roll_random, 1000000));
    printf("type: s&5  winrate: %f\n", average_win_rate(final_strategy, swap_and_5, 1000000));
    printf("type: s    winrate: %f\n", average_win_rate(final_strategy, just_swap, 1000000));
}
